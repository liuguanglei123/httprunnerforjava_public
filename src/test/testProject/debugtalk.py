...
def funcWithoutParam():
    return "android_chuizi"

def funcWithParam(var1,var2):
    return var1 + var2

def setup_hooks(var1):
    print("setup_hooks execute")

def teardown_hooks(var1,var2):
    print("teardown_hooks execute")

def setup_hooks1(var1):
    print("setup_hooks1 execute")

def setup_hooks2(var1):
    print("setup_hooks2 execute")

def setup_testcase():
    print("setup_testcase execute")

def funct1(var1,var2):
    return "0126"
